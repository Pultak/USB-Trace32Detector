...
namespace LDClientTests.detection
{
    internal class InfoFetcherTests
    {
        ...
        public void Setup()
        {
            ...
            _defaultFetcher = new T32RemFetcher(DefaultMaxAttempts, 50, 1000, "info.txt", "executable.exe",
            ...
            _fetcherWithoutPars = new T32RemFetcher(DefaultMaxAttempts, 50, 1000, "info.txt", "executable.exe",
                null, 0, 50)
            {
                FileUtils = _mockFileUtils.Object,
                ProcessUtils = _mockProcessUtils.Object
