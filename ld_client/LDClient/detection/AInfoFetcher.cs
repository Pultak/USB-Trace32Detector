...
namespace LDClient.detection
{
    ...
    public abstract class AInfoFetcher : IInfoFetcher
    {
        ...
        /// </summary>
        protected readonly uint _practiceScriptPollingPeriodMs;
        ...
        protected AInfoFetcher(uint maxAttempts, uint waitPeriodMs, uint practiceScriptPollingPeriodMs, string infoFilePath)
        {
            this.FileUtils = new FileUtils();
            this._maxAttempts = maxAttempts;
            this._waitPeriodMs = waitPeriodMs;
            this._infoFilePath = infoFilePath;
            this._practiceScriptPollingPeriodMs = practiceScriptPollingPeriodMs;
        }
